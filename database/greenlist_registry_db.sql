...
(
    ...
    VALUES
        ...
        ('Piñatex', 'When it comes to vegan leather alernatives, Piñatex is the material to look out for. This futuristic material is made from pineapple leaf fibre. Not only is it a cruelty-free replacement for leatther, it is natural and sustainable. Because Piñatex is made from a food, it reduces wasttte and helps the farming communities that grow the fruit!', 'need phottokjjkj', 'miissingsocial', 'missingenvir', 'missingcost'),
    ...
    VALUES
        ...
        ('Interlock', 'This GOTS certified interlock is soft to the touch and pleasing to the eye. You''ll appreciate its slight stretch and great rebound. Made in India.', 1 , 1, ''),
