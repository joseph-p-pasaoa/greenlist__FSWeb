...
(
    ...
    VALUES
        ...
        ('Recycled Polyester', 'Recycled polyester uses PET (the chemical used to create polyester) from plastic water bottles and breaks them down into fibers. This recycled fabric keeps plastic out of landfills and can be recycled many times over!', 'http://localhost:11500/images/materials/recycledPolyester.jpg', 'Recycled Polyester minimizes the amount of plastic bottles found in landfills.', 'As Recycled Polyester can also be recycled over again, it minimizes future wastage on landfills without compromising the quality.', 'Recycled Polyester saves 45-60% in non-renewable energy compared to polyester.'),

        ('Reclaimed', 'Reclaimed, or deadstock, fabric is material leftover from manufacturers, vintage frabic, or any other unused fabric that is brought secondhand.', 'http://localhost:11500/images/materials/reclaimed.jpg','Reusing deadstock or leftover materials saves this fabrics from landfills.', 'Reclaimed clothing utilizeshe idea of zero-waste thus, preventing more textile waste and reduces carbon footprint.', 'Not only does Reclaimed clothing adds more value of an unwanted garment, Reclaimed clothing conserves energy.'),

        ('Piñatex', 'When it comes to vegan leather alernatives, Piñatex is the material to look out for. This futuristic material is made from pineapple leaf fibre. Not only is it a cruelty-free replacement for leatther, it is natural and sustainable. Because Piñatex is made from a food, it reduces wasttte and helps the farming communities that grow the fruit!', 'http://localhost:11500/images/materials/pinatex.jpg', 'Piñatex is made from cellulose fibres extracted from pineapple leaves which are often discarded or burned. By adding value to the waste, Piñatex promotes the production of pineapples from farming communites.', 'During production, Piñatex uses no harmful chemicals. This makes it safe for animals, humans and the enviornment. The underlying material is 100% biodegradable.', 'To create Piñatex, it requires very low amount fo water usage and and low production waste.'),
